...
class CreateTeacherAccount extends StatefulWidget{
  CreateTeacherAccount({Key key}) : super (key: key);
...
class _TeacherChatPage extends State<CreateTeacherAccount>{

  Future getData()async{
    var url="http://192.168.1.131/flutter-login-register/display_teacher.php";
